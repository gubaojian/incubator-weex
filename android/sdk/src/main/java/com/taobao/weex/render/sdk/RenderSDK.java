...
public class RenderSDK {
    ...
    private FrameImageAdapter imageAdapter;
    ...
    private void initSdk(){
        if(!isInited){
            synchronized (this){
                ...
                application.unregisterActivityLifecycleCallbacks(renderLifecycleCallback);
                application.unregisterComponentCallbacks(renderLifecycleCallback);
                application.registerActivityLifecycleCallbacks(renderLifecycleCallback);
                application.registerComponentCallbacks(renderLifecycleCallback);
                try {
