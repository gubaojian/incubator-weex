 ...
 */
public class WXAttr extends  ArrayMap<String, Object>  implements Cloneable {
  ...
  public WXAttr(@NonNull Map<String,Object> standardMap) {
    super.putAll(filterBindingStatement(standardMap));
  }
  ...
  public void putAll(Map<? extends String, ?> map) {
    super.putAll(filterBindingStatement(map));
  }
  ...
  protected WXAttr clone(){
    ...
    wxAttr.putAll((SimpleArrayMap<? extends String, ?>) this);
