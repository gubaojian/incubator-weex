...
public class TraceAction {
    ...
    public WXTracing.TraceEvent mBeginEvent;
    ...
    public WXTracing.TraceEvent submitPerformance(String fname, String ph, String instanceId, double duration, long ts, boolean... isSegment) {
        if (WXTracing.isAvailable()) {
