...
public class UpdateStylesAction extends  Action {
    ...
    public UpdateStylesAction(RenderFrame documentView, String ref, Map<String, String> styles) {
        super(documentView);
        this.ref = ref;
        this.styles = styles;
    }
    ...
    protected void execute() {
        RenderLog.actionUpdateStyles(getRenderFrame(), ref, styles);
        RenderBridge.getInstance().actionUpdateStyles(getRenderFrame().getNativeFrame(), ref, styles);
