...
public class RenderFrameAccessibilityHelper extends ExploreByTouchHelper {

    private RenderFrameView renderFrameView;
    private RenderFrameAccessibilityTask renderFrameViewAccessibilityTask;

    public RenderFrameAccessibilityHelper(RenderFrameView documentTextureView) {
    ...
    protected int getVirtualViewAt(float x, float y) {
        ...
        this.renderFrameViewAccessibilityTask = new RenderFrameAccessibilityTask(renderFrameView.getRenderFrame(),0, 0);
