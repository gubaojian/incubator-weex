...
public class DestoryFrameAction extends  Action {


    public DestoryFrameAction(RenderFrame renderFrame) {
        super(renderFrame);
    }
    ...
    protected void execute() {
        ...
        if(mNativeFrame != 0){
            RenderBridge.getInstance().destroyFrame(mNativeFrame);
            getRenderFrame().setNativeFrame(0);
        }
    }
}
