...
public class UpdateAttrsAction extends Action {
    ...
    public UpdateAttrsAction(RenderFrame documentView, String ref, Map<String, String> attrs) {
        super(documentView);
        this.ref = ref;
        this.attrs = attrs;
    }
    ...
    protected void execute() {
        RenderLog.actionUpdateAttrs(getRenderFrame(), ref, attrs);
        RenderBridge.getInstance().actionUpdateAttrs(getRenderFrame().getNativeFrame(), ref, attrs);
