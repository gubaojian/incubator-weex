...
public class RemoveEventAction extends  Action {
    ...
    public RemoveEventAction(RenderFrame documentView, String ref, String event) {
        super(documentView);
        this.ref = ref;
        this.event = event;
    }
    ...
    protected void execute() {
        ...
        RenderLog.actionRemoveEvent(getRenderFrame(), ref, event);
        RenderBridge.getInstance().actionRemoveEvent(getRenderFrame().getNativeFrame(), ref, event);
    }
}
