...
public class MoveElementAction extends  Action {
    ...
    public MoveElementAction(RenderFrame documentView, String ref, String parentRef, int index) {
        super(documentView);
        this.ref = ref;
    ...
    protected void execute() {
        RenderLog.actionMoveElement(getRenderFrame(), ref, parentRef, index);
        RenderBridge.getInstance().actionMoveElement(getRenderFrame().getNativeFrame(), ref, parentRef, index);
