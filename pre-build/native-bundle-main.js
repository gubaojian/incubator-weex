(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.23.5, Build 2017-12-19 15:24.');
(this.getJSFMVersion = function(){return "0.23.5"});
 ...
 * @param  {object} data
 */
function init$1 (app, code, data, services) {
  ...
  var bundleRegister = function () {
    ...
    return register.apply(void 0, [ app ].concat( args ));
  };
  /* istanbul ignore next */
...
function createInstance$1 (id, code, options, data, info) {
  ...
  if (!instance) {
    ...
    result = init$1(instance, code, data, services);
  }
  else {
...
var jsHandlers = {
  fireEvent: function (id) {
    ...
    return fireEvent.apply(void 0, [ instanceMap$1[id] ].concat( args ))
  },
  callback: function (id) {
    var args = [], len = arguments.length - 1;
    while ( len-- > 0 ) args[ len ] = arguments[ len + 1 ];

    return callback.apply(void 0, [ instanceMap$1[id] ].concat( args ))
  }
};
...
var subversion = {"browser":"0.5.0","framework":"0.23.5","vue-render":"0.12.26","transformer":">=0.1.5 <0.5"};
...
var _setToStringTag = function (it, tag, stat) {
  if (it && !has$2(it = stat ? it : it.prototype, TAG$1)) { def$1(it, TAG$1, { configurable: true, value: tag }); }
};
...
var _microtask = function () {
  ...
  } else if (Observer$1 && !(global$6.navigator && global$6.navigator.standalone)) {
    var toggle = true;
...
var runtime = {
  ...
  service: { register: register$1, unregister: unregister, has: has$4 },
