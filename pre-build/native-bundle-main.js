(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.24.1, Build 2018-01-10 10:53. (Vue: 2.5.11-weex.2, Rax: 0.4.20)');
...
CallbackManager.prototype.registerHook = function registerHook (componentId, type, hookName, hookFunction) {
  ...
  console.log(' => register component hook: ' + key)
  if (this.hooks[key]) {
...
CallbackManager.prototype.triggerHook = function triggerHook (componentId, type, hookName, options) {
  ...
  console.log(' => trigger component hook: ' + key + ' ' + typeof hookFunction)
...
function initVirtualComponent (options) {
  ...
  console.log(' => init virtual component: ' + vm._uid)
  ...
  var data = typeof _data === 'function'
    ? getData(_data, vm)
    : _data || {};
  if (isPlainObject(data)) {
  ...
  registerComponentHook(componentId, 'lifecycle', 'attach', function () {
    callHook(vm, 'beforeMount');
    console.log(' => attach virtual component: ' + vm._uid)
    ...
    Object.keys(data).forEach(function (key) {
      vm.$watch(key, function (newValue) {
        console.log(' => watch (' + key + ') changed to: ' + newValue);
        updateComponentData(componentId, ( obj = {}, obj[key] = newValue, obj));
      }, { deep: true });
    });
  ...
  vnode.componentOptions.Ctor = BaseCtor.extend({
    methods: {
      registerVirtualComponent: function registerVirtualComponent () {
        ...
        console.log(' => register virtual component: ' + vm._uid);
        ...
        registerComponentHook(
          ...
          function (componentId, propsData) {
            console.log(' => create virtual component: ' + componentId + ' ' + JSON.stringify(propsData));
  ...
  if (targetContext && targetContext._virtualComponents) {
    ...
    handler = function virtualHandler () {
      ...
      if (componentId && this._context) {
        ...
        if (vcs[componentId]) {
          console.log(' => invoke handler '+ componentId)
        }
