...
qking_value_t
qkingx_handler_create_err (const qking_value_t func_obj_val, /**< function object */
                       const qking_value_t this_p, /**< this arg */
                       const qking_value_t args_p[], /**< function arguments */
                       const qking_length_t args_cnt) /**< number of function arguments */
{
  return qking_create_error (QKING_ERROR_COMMON,"built-in error by qking_create_error");
} /* qkingx_handler_assert */
