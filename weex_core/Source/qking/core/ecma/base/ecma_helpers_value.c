...
QKING_STATIC_ASSERT (ECMA_TYPE___MAX <= ECMA_VALUE_TYPE_MASK,
                     ecma_types_must_be_less_than_mask);

QKING_STATIC_ASSERT ((ECMA_VALUE_TYPE_MASK + 1) == (1 << ECMA_VALUE_SHIFT),
                     ecma_value_part_must_start_after_flags);

QKING_STATIC_ASSERT (ECMA_VALUE_SHIFT <= JMEM_ALIGNMENT_LOG,
                     ecma_value_shift_must_be_less_than_or_equal_than_mem_alignment_log);

QKING_STATIC_ASSERT (sizeof (jmem_cpointer_t) <= sizeof (ecma_value_t),
                     size_of_jmem_cpointer_t_must_be_less_or_equal_to_the_size_of_ecma_value_t);

#ifdef ECMA_VALUE_CAN_STORE_UINTPTR_VALUE_DIRECTLY

QKING_STATIC_ASSERT (sizeof (uintptr_t) <= sizeof (ecma_value_t),
...
QKING_STATIC_ASSERT ((ECMA_VALUE_FALSE | (1 << ECMA_DIRECT_SHIFT)) == ECMA_VALUE_TRUE
 ...
 * @return type field
 */
inline ecma_type_t QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
 ...
 * @return ecma value
 */
static inline ecma_value_t QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
ecma_pointer_to_ecma_value (const void *ptr) /**< pointer */
{
#ifdef ECMA_VALUE_CAN_STORE_UINTPTR_VALUE_DIRECTLY

  QKING_ASSERT (ptr != NULL);
  uintptr_t uint_ptr = (uintptr_t) ptr;
  QKING_ASSERT ((uint_ptr & ECMA_VALUE_TYPE_MASK) == 0);
 ...
 * @return pointer
 */
static inline void * QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
 ...
 *         false - otherwise
 */
inline bool QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
 ...
 *         false - otherwise
 */
static inline bool QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
...
{
  QKING_STATIC_ASSERT (ECMA_DIRECT_TYPE_INTEGER_VALUE == 0,
...
QKING_STATIC_ASSERT ((ECMA_TYPE_STRING | 0x4) == ECMA_TYPE_DIRECT_STRING,
...
/**
 * Check if the value is object array.
 *
 * @return true - if the value contains object array value,
 *         false - otherwise
 */
inline bool QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
ecma_is_value_object_array (ecma_value_t value) /**< ecma value */
{
...
{
  QKING_ASSERT (ecma_is_value_undefined (value)
 ...
 */
inline ecma_value_t QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
...
{
  QKING_ASSERT (ECMA_IS_INTEGER_NUMBER (integer_value));
 ...
 */
inline ecma_value_t QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
ecma_make_string_value (const ecma_string_t *ecma_string_p) /**< string to reference in value */
{
  QKING_ASSERT (ecma_string_p != NULL);
 ...
 */
inline ecma_integer_value_t QKING_ATTR_CONST QKING_ATTR_ALWAYS_INLINE
ecma_get_integer_from_value (ecma_value_t value) /**< ecma value */
{
  QKING_ASSERT (ecma_is_value_integer_number (value));
 ...
 */
inline ecma_number_t QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
ecma_get_float_from_value (ecma_value_t value) /**< ecma value */
{
  QKING_ASSERT (ecma_get_value_type_field (value) == ECMA_TYPE_FLOAT);
 ...
 */
inline ecma_string_t *QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
ecma_get_string_from_value (ecma_value_t value) /**< ecma value */
{
  QKING_ASSERT (ecma_is_value_string (value));
 ...
 * @return the pointer
 */
inline ecma_object_t *QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
 ...
 * @return the pointer
 */
inline ecma_error_reference_t *QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
ecma_get_error_reference_from_value (ecma_value_t value) /**< ecma value */
{
  QKING_ASSERT (ecma_get_value_type_field (value) == ECMA_TYPE_ERROR);
...
{
  QKING_ASSERT (ecma_get_value_type_field (value) == ECMA_TYPE_POINTER);
...
{
  QKING_ASSERT (ecma_is_value_boolean (value));
...
ecma_copy_value (ecma_value_t value)  /**< value description */
{
  switch (ecma_get_value_type_field (value))
  {
    ...
    default:
    {
      QKING_ASSERT (ecma_get_value_type_field (value) == ECMA_TYPE_DIRECT
...
{
  QKING_STATIC_ASSERT (ECMA_TYPE_DIRECT == 0,
...
{
  QKING_ASSERT (ecma_is_value_float_number (float_value));
...
ecma_get_typeof_lit_id (ecma_value_t value) /**< input ecma value */
{
  ...
  QKING_ASSERT (ret_value != LIT_MAGIC_STRING__EMPTY);
