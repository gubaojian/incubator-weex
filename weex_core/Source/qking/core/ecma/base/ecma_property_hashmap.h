...
typedef enum {
  ...
  ECMA_PROPERTY_HASHMAP_DELETE_RECREATE_HASHMAP, /**< hashmap should be
                                                    recreated */
...
void ecma_property_hashmap_insert(ecma_object_t *object_p,
                                  ...
                                  int property_index);
ecma_property_hashmap_delete_status ecma_property_hashmap_delete(
    ecma_object_t *object_p, jmem_cpointer_t name_cp,
    ecma_property_t *property_p);

#ifndef CONFIG_ECMA_PROPERTY_HASHMAP_DISABLE
ecma_property_t *ecma_property_hashmap_find(
    ecma_property_hashmap_t *hashmap_p, ecma_string_t *name_p,
