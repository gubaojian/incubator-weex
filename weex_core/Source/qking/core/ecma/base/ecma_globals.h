...
typedef enum {
  ...
  ECMA_STATUS_HIGH_SEV_GC =
      (1u << 1), /**< last gc run was a high severity run */
#endif           /* !CONFIG_ECMA_PROPERTY_HASHMAP_DISABLE */
  ECMA_STATUS_EXCEPTION =
      (1u << 2), /**< last exception is a normal exception */
} ecma_status_flag_t;
 ...
 */
typedef enum {
  ECMA_TYPE_DIRECT = 0, /**< directly encoded value, a 28 bit signed integer or
                           a simple value */
  ...
  ECMA_TYPE_ERROR = 7, /**< pointer to description of an error reference (only
                          supported by C API) */
  ECMA_TYPE_POINTER = ECMA_TYPE_ERROR, /**< a generic aligned pointer */
  ECMA_TYPE_SNAPSHOT_OFFSET =
      ECMA_TYPE_ERROR,              /**< offset to a snapshot number/string */
...
typedef enum {
  ...
  /* These three status flags must be in this order. See
     PARSER_CLASS_PARSE_OPTS_OFFSET. */
  ECMA_PARSE_CLASS_CONSTRUCTOR =
      (1u << 1), /**< a class constructor is being parsed (this value must be
                  * kept in in sync with PARSER_CLASS_CONSTRUCTOR) */
  ECMA_PARSE_HAS_SUPER =
      (1u << 2), /**< the current context has super reference */
  ECMA_PARSE_HAS_STATIC_SUPER =
      (1u << 3), /**< the current context is a static class method */
} ecma_parse_opts_t;
...
/**
 * Type for directly encoded integer numbers in Qking.
 */
 ...
 */
#define ECMA_DIRECT_TYPE_INTEGER_VALUE \
  ((0u << ECMA_VALUE_SHIFT) | ECMA_TYPE_DIRECT)

/**
 * Ecma simple value type
 */
#define ECMA_DIRECT_TYPE_SIMPLE_VALUE \
  ((1u << ECMA_VALUE_SHIFT) | ECMA_TYPE_DIRECT)
...
#define ECMA_MAKE_VALUE(value)                      \
  ((((ecma_value_t)(value)) << ECMA_DIRECT_SHIFT) | \
...
/**
 * Maximum integer number for an ecma value (shifted left with
 * ECMA_DIRECT_SHIFT)
 */
...
/**
 * Minimum integer number for an ecma value (shifted left with
 * ECMA_DIRECT_SHIFT)
 */
...
#error \
    "Please update ECMA_INTEGER_NUMBER_MIN/MAX_SHIFTED according to the new value of ECMA_DIRECT_SHIFT."
#endif
 ...
 */
#define ECMA_IS_VALUE_ERROR(value) (QKING_UNLIKELY((value) == ECMA_VALUE_ERROR))
 ...
 */
typedef struct {
  ecma_object_native_free_callback_t
 ...
 */
typedef enum {
  ECMA_PROPERTY_NOT_CONFIGURABLE, /**< property's 'Configurable' attribute is
                                     false */
...
typedef enum {
  ...
  ECMA_PROPERTY_TYPE_VIRTUAL =
      ECMA_PROPERTY_TYPE_INTERNAL, /**< property is virtual data property */

  ECMA_PROPERTY_TYPE__MAX =
      ECMA_PROPERTY_TYPE_VIRTUAL, /**< highest value for property types. */
 ...
 */
typedef enum {
  ECMA_CODE_FLAGS_FUNCTION =
      (1u << 0), /**< compiled code is JavaScript function */
  ECMA_CODE_FLAGS_FULL_LITERAL_ENCODING =
      (1u << 1), /**< full literal encoding mode is enabled */
  ECMA_CODE_FLAGS_UINT16_ARGUMENTS =
      (1u << 2), /**< compiled code data is cbc_uint16_arguments_t */
  ECMA_CODE_FLAGS_STRICT_MODE = (1u << 3), /**< strict mode is enabled */
  ECMA_CODE_FLAGS_ARGUMENTS_NEEDED =
      (1u << 4), /**< arguments object must be constructed */
  ECMA_CODE_FLAGS_LEXICAL_ENV_NOT_NEEDED =
      (1u << 5), /**< no need to create a lexical environment */
  ECMA_CODE_FLAGS_ARROW_FUNCTION =
      (1u << 6), /**< this function is an arrow function */
  ECMA_CODE_FLAGS_STATIC_FUNCTION =
      (1u << 7), /**< this function is a static snapshot function */
  ECMA_CODE_FLAGS_DEBUGGER_IGNORE =
      (1u << 8), /**< this function should be ignored by debugger */
  ECMA_CODE_FLAGS_CONSTRUCTOR =
      (1u << 9), /**< this function is a constructor */

} ecma_code_flags;

/* ECMA_PARSER_TRY_CONTEXT_STACK_ALLOCATION must be <= 3 */
#define ECMA_PARSER_TRY_CONTEXT_STACK_ALLOCATION 2

/* ECMA_PARSER_WITH_CONTEXT_STACK_ALLOCATION must be <= 4 */
#define ECMA_PARSER_WITH_CONTEXT_STACK_ALLOCATION 1
...
typedef enum {
  ECMA_PROPERTY_FLAG_CONFIGURABLE =
      1u << (ECMA_PROPERTY_FLAG_SHIFT + 0), /**< property is configurable */
  ECMA_PROPERTY_FLAG_ENUMERABLE =
      1u << (ECMA_PROPERTY_FLAG_SHIFT + 1), /**< property is enumerable */
  ECMA_PROPERTY_FLAG_WRITABLE =
      1u << (ECMA_PROPERTY_FLAG_SHIFT + 2), /**< property is writable */
  ECMA_PROPERTY_FLAG_LCACHED =
      1u << (ECMA_PROPERTY_FLAG_SHIFT + 3), /**< property is lcached */
...
#define ECMA_CONVERT_DATA_PROPERTY_TO_INTERNAL_PROPERTY(property_p)        \
  *(property_p) = (uint8_t)(*(property_p) + (ECMA_PROPERTY_TYPE_INTERNAL - \
...
#define ECMA_SPECIAL_PROPERTY_VALUE(type) \
  ((uint8_t)(ECMA_PROPERTY_TYPE_SPECIAL | \
             ((type) << ECMA_PROPERTY_NAME_TYPE_SHIFT)))

/**
 * Type of deleted property.
 */
#define ECMA_PROPERTY_TYPE_DELETED \
  ECMA_SPECIAL_PROPERTY_VALUE(ECMA_SPECIAL_PROPERTY_DELETED)

/**
 * Type of hash-map property.
 */
#define ECMA_PROPERTY_TYPE_HASHMAP \
  ECMA_SPECIAL_PROPERTY_VALUE(ECMA_SPECIAL_PROPERTY_HASHMAP)
 ...
 * This pair is represented by a single pointer in Qking. Although
 ...
 * anymore.
 */
typedef uint8_t ecma_property_t; /**< ecma_property_types_t (3 bit) and
                                    ecma_property_flags_t */
...
typedef struct {
  ...
  ecma_property_t
      types[ECMA_PROPERTY_PAIR_ITEM_COUNT]; /**< two property type slot. The
                                             * first represent
                                             *   the type of this property (e.g.
                                             * property pair) */
...
typedef struct {
  ...
  ecma_property_value_t
      values[ECMA_PROPERTY_PAIR_ITEM_COUNT]; /**< property value slots */
  jmem_cpointer_t
      names_cp[ECMA_PROPERTY_PAIR_ITEM_COUNT]; /**< property name slots */
...
#define ECMA_PROPERTY_VALUE_ADD_OFFSET(property_p) \
  ((uintptr_t)(                                    \
      (((uint8_t *)(property_p)) + (sizeof(ecma_property_value_t) * 2 - 1))))

/**
 * Align the property for computing its property data pointer.
 */
#define ECMA_PROPERTY_VALUE_DATA_PTR(property_p) \
  (ECMA_PROPERTY_VALUE_ADD_OFFSET(property_p) &  \
   ~(sizeof(ecma_property_value_t) - 1))
...
typedef union {
  ecma_property_value_t
      *value_p;               /**< property value pointer for real properties */
...
typedef struct {
  ...
  ecma_property_t
      *property_p; /**< property descriptor pointer for real properties */
...
typedef enum {
  ECMA_PROPERTY_GET_NO_OPTIONS =
      0, /**< no option flags for ecma_op_object_get_property */
  ECMA_PROPERTY_GET_VALUE =
      1u << 0, /**< fill virtual_value field for virtual properties */
  ECMA_PROPERTY_GET_EXT_REFERENCE =
      1u << 1, /**< get extended reference to the property */
...
typedef enum {
  ECMA_OBJECT_TYPE_GENERAL =
      0, /**< all objects that are not belongs to the sub-types below. */
  ECMA_OBJECT_TYPE_CLASS = 1, /**< Objects with class property */
  ECMA_OBJECT_TYPE_FUNCTION =
      2, /**< Function objects (15.3), created through 13.2 routine */
  ECMA_OBJECT_TYPE_EXTERNAL_FUNCTION =
      3,                      /**< External (host) function object */
  ECMA_OBJECT_TYPE_ARRAY = 4, /**< Array object (15.4) */
  ECMA_OBJECT_TYPE_BOUND_FUNCTION =
      5, /**< Function objects (15.3), created through 15.3.4.5 routine */
  ECMA_OBJECT_TYPE_PSEUDO_ARRAY =
      6, /**< Array-like object, such as Arguments object (10.6) */
#ifndef CONFIG_DISABLE_ES2015_ARROW_FUNCTION
  ECMA_OBJECT_TYPE_ARROW_FUNCTION = 7, /**< arrow function objects */
#endif /* !CONFIG_DISABLE_ES2015_ARROW_FUNCTION */
  /* Types between 13-15 cannot have a built-in flag. See
...
typedef enum {
  ...
  ECMA_PSEUDO_ARRAY_TYPEDARRAY = 1, /**< TypedArray which does NOT need extra
                                       space to store length and offset */
  ECMA_PSEUDO_ARRAY_TYPEDARRAY_WITH_INFO =
      2, /**< TypedArray which NEEDS extra space to store length and offset */

  ECMA_PSEUDO_ARRAY__MAX =
      ECMA_PSEUDO_ARRAY_TYPEDARRAY_WITH_INFO /**< maximum value */
...
typedef enum {
  ...
  ECMA_LEXICAL_ENVIRONMENT_DECLARATIVE =
      13, /**< declarative lexical environment */
  ECMA_LEXICAL_ENVIRONMENT_THIS_OBJECT_BOUND =
      14, /**< object-bound lexical environment
           *   with provideThis flag */
  ECMA_LEXICAL_ENVIRONMENT_SUPER_OBJECT_BOUND =
      15, /**< object-bound lexical environment
           *   with provided super reference */

  ECMA_LEXICAL_ENVIRONMENT_TYPE_START =
      ECMA_LEXICAL_ENVIRONMENT_DECLARATIVE, /**< first lexical
                                             *   environment type */
  ECMA_LEXICAL_ENVIRONMENT_TYPE__MAX =
      ECMA_LEXICAL_ENVIRONMENT_SUPER_OBJECT_BOUND /**< maximum value */
} ecma_lexical_environment_type_t;
...
/**
 * Ecma object is built-in or lexical environment. When this flag is set, the
 * object is a
 *   - built-in, if object type is less than
 * ECMA_LEXICAL_ENVIRONMENT_TYPES_START
 *   - lexical environment, if object type is greater or equal than
 * ECMA_LEXICAL_ENVIRONMENT_TYPES_START
 */
...
typedef struct {
  /** type : 4 bit : ecma_object_type_t or ecma_lexical_environment_type_t
      ...
      flags : 2 bit : ECMA_OBJECT_FLAG_BUILT_IN_OR_LEXICAL_ENV,
                      ECMA_OBJECT_FLAG_EXTENSIBLE or
     ECMA_OBJECT_FLAG_NON_CLOSURE refs : 10 bit (max 1023) */
...
typedef struct {
  ...
  union {
    ...
    struct {
      ...
      uint16_t
          extra_info; /**< extra information for the object
       ...
       */
      union {
        ecma_value_t value; /**< value of the object (e.g. boolean, number,
                               string, etc.) */
        uint32_t
            length; /**< length related property (e.g. length of ArrayBuffer) */
      } u;
    } class_prop;
    ...
    /**
     * Description of value ref object.
     */
    struct {
      ecma_value_t *var; /**< target value */
...
typedef struct {
  ...
  uint16_t
      status_flags; /**< various status flags:
                     *   ECMA_CODE_FLAGS_FUNCTION flag tells whether
                     *   the byte code is function or regular expression.
                     *   If function, the other flags must be ECMA_CODE_FLAGS...
...
struct ecma_func_out_closure_t;
struct ecma_func_in_closure_t;
struct ecma_closure_t;

typedef struct ecma_register_t {
  ecma_value_t var;
  struct ecma_closure_t *closure_p;
  struct ecma_register_t *next_p;

} ecma_register_t;

typedef struct ecma_closure_t {
  uint16_t refs_and_container; /**< reference counter for the closure */
  ecma_value_t var;            /** weak reference for the value */
  struct ecma_register_t *register_p;
...
typedef struct ecma_compiled_function_state_t {
  ...
  uint32_t out_closure;
  struct ecma_compiled_function_state_t **pp_childrens;
  uint32_t childrens;
  unsigned long *pc;
  uint32_t pcc;
  uint8_t argc;
...
} ecma_compiled_function_state_t;

/**
 * Function value ref.
 * Heap no gc alloc memory
 */
typedef struct ecma_func_out_closure_t {
  ecma_compiled_function_state_t
      *func_state_p; /* ecma_compiled_function_state_t */
  long idx;

} ecma_func_out_closure_t;

typedef struct ecma_func_in_closure_t {
  ecma_func_out_closure_t *out_closure_p;
  long idx;

} ecma_func_in_closure_t;
...
typedef struct {
  ecma_value_t
      items[ECMA_MAP_OBJECT_ITEM_COUNT +
...
typedef enum {
  ECMA_COLLECTION_NO_REF_OBJECTS =
      (1u << 0), /**< do not increase the refcount of objects */
 ...
 */
typedef struct {
  jmem_cpointer_t first_chunk_cp; /**< compressed pointer to first chunk with
                                     collection's data */
  jmem_cpointer_t last_chunk_cp;  /**< compressed pointer to last chunk with
                                     collection's data */
  ecma_length_t item_count;       /**< number of items in the collection */
} ecma_collection_header_t;

/**
 * Maximum number of items stored by a collection chunk (excluding the last
...
typedef struct {
  ecma_value_t
      items[ECMA_COLLECTION_CHUNK_ITEMS +
 ...
 */
typedef enum {
  ECMA_DIRECT_STRING_PTR =
      0, /**< string is a string pointer, only used by property names */
 ...
 */
#define ECMA_DIRECT_STRING_MASK \
  ((uintptr_t)(ECMA_DIRECT_TYPE_MASK | (0x3u << ECMA_VALUE_SHIFT)))

/**
 * Create an ecma direct string.
 */
#define ECMA_CREATE_DIRECT_STRING(type, value)                          \
  ((uintptr_t)(ECMA_TYPE_DIRECT_STRING | ((type) << ECMA_VALUE_SHIFT) | \
               (value) << ECMA_DIRECT_STRING_SHIFT))
...
#define ECMA_IS_DIRECT_STRING_WITH_TYPE(string_p, type)   \
  ((((uintptr_t)(string_p)) & ECMA_DIRECT_STRING_MASK) == \
   ECMA_CREATE_DIRECT_STRING(type, 0))
 ...
 */
#define ECMA_STRING_TYPE_CONVERSION_SHIFT \
  (ECMA_PROPERTY_NAME_TYPE_SHIFT - ECMA_VALUE_SHIFT)

/**
 * Converts direct string type to property name type.
 */
#define ECMA_DIRECT_STRING_TYPE_TO_PROP_NAME_TYPE(string_p) \
  ((((uintptr_t)(string_p)) & (0x3 << ECMA_VALUE_SHIFT))    \
   << ECMA_STRING_TYPE_CONVERSION_SHIFT)
 ...
 */
typedef enum {
  ECMA_STRING_CONTAINER_HEAP_UTF8_STRING, /**< actual data is on the heap as an
                                           * utf-8 (cesu8) string maximum size
                                           * is 2^16. */
  ECMA_STRING_CONTAINER_HEAP_LONG_UTF8_STRING, /**< actual data is on the heap
                                                * as an utf-8 (cesu8) string
                                                *   maximum size is 2^32. */
  ECMA_STRING_CONTAINER_UINT32_IN_DESC,  /**< actual data is UInt32-represeneted
                                            Number
                                              stored locally in the string's
                                            descriptor */
  ECMA_STRING_CONTAINER_MAGIC_STRING_EX, /**< the ecma-string is equal to one of
                                            external magic strings */

  ECMA_STRING_LITERAL_NUMBER, /**< a literal number which is used solely by the
                               * literal storage so no string processing
                               * function supports this type except the
                               * ecma_deref_ecma_string function. */
...
#define ECMA_CLOSURE_REF_ONE (1u)

#define ECMA_BYTECODE_REF_ONE (1u)
...
#define ECMA_STRING_GET_CONTAINER(string_desc_p)                   \
  ((ecma_string_container_t)((string_desc_p)->refs_and_container & \
...
typedef struct {
  ...
  /**
   * Actual data or identifier of it's place in container (depending on
   * 'container' field)
   */
  union {
    /**
    ...
    lit_utf8_size_t
        long_utf8_string_size; /**< size of this long utf-8 string in bytes */
    uint32_t uint32_number; /**< uint32-represented number placed locally in the
                               descriptor */
    ...
    uint32_t
        common_uint32_field; /**< for zeroing and comparison in some cases */
  } u;
} ecma_string_t;
...
typedef struct {
  ...
  lit_utf8_size_t
      long_utf8_string_length; /**< length of this long utf-8 string in bytes */
} ecma_long_string_t;
 ...
 */
typedef enum {
  ECMA_ARRAYBUFFER_INTERNAL_MEMORY =
      0u, /* ArrayBuffer memory is handled internally. */
  ECMA_ARRAYBUFFER_EXTERNAL_MEMORY =
      (1u
       << 0), /* ArrayBuffer created via qking_create_arraybuffer_external. */
} ecma_arraybuffer_extra_flag_t;

#define ECMA_ARRAYBUFFER_HAS_EXTERNAL_MEMORY(object_p)              \
  ((((ecma_extended_object_t *)object_p)->u.class_prop.extra_info & \
    ECMA_ARRAYBUFFER_EXTERNAL_MEMORY) != 0)

/**
 * Struct to store information for ArrayBuffers with external memory.
 *
 * The following elements are stored in Qking memory.
 *
 *  buffer_p - pointer to the external memory.
 *  free_cb - pointer to a callback function which is called when the
 * ArrayBuffer is freed.
 */
typedef struct {
  ecma_extended_object_t extended_object; /**< extended object part */
  void *buffer_p;                         /**< external buffer pointer */
  ecma_object_native_free_callback_t
      free_cb; /**<  the free callback for the above buffer pointer */
