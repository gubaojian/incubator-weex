 ...
 * @{
 *
 * \addtogroup ecmaalloc Routines for allocation/freeing memory for ECMA data
 * types
 * @{
 */
 ...
 * @return pointer to allocated memory
 */
ecma_closure_t *ecma_alloc_closure(void);

/**
 * Dealloc memory from ecma-closure descriptor
 */
void ecma_dealloc_closure(ecma_closure_t *closure_p);
