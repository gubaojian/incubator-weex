...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_function_prototype.inc.h"
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        QKING_ASSERT (ecma_is_value_empty (get_result));
                                             ...
                                             ecma_length_t arguments_number) /**< number of arguments */
{
  ...
  else
  {
    ...
    {
      QKING_ASSERT (arguments_number > 0);
