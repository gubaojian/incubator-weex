...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_string.inc.h"
                                           ...
                                           ecma_length_t args_number) /**< number of arguments */
{
       ...
       arg_index++)
  {
    ...
    QKING_ASSERT (utf8_buf_used <= utf8_buf_size - LIT_UTF8_MAX_BYTES_IN_CODE_UNIT);
    utf8_buf_used += lit_code_unit_to_utf8 (code_unit, utf8_buf_p + utf8_buf_used);
    QKING_ASSERT (utf8_buf_used <= utf8_buf_size);
