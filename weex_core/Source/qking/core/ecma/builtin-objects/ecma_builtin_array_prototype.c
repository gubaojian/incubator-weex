...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_array_prototype.inc.h"
                                            ...
                                            ecma_length_t args_number) /**< number of arguments */
{
  ...
  QKING_ASSERT (!ECMA_IS_VALUE_ERROR (new_array));
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
         ...
         */
        QKING_ASSERT (ecma_op_is_callable (compare_func));
                                          ...
                                          ecma_value_t arg1) /**< comparefn */
{
  ...
  QKING_ASSERT (copied_num == defined_prop_count
...
{
  QKING_ASSERT (mode < ARRAY_ROUTINE__COUNT);
  ...
  else
  {
    ...
    QKING_ASSERT (!ECMA_IS_VALUE_ERROR (to_object_comp));
                                         ...
                                         ecma_value_t arg2) /**< thisArg */
{
  ...
  {
    ecma_object_t *func_object_p;
    QKING_ASSERT (ecma_is_value_object (arg1));
                                ...
                                bool start_from_left) /**< whether the reduce starts from left or right */
{
  ...
  else
  {
    ...
    QKING_ASSERT (ecma_is_value_object (callbackfn));
