...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_date_prototype.inc.h"
                                          ...
                                          ecma_number_t date_num) /**< date converted to number */
{
  ...
  switch (builtin_routine_id)
  {
    ...
    default:
    {
      QKING_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_GET_UTC_TIMEZONE_OFFSET);
                                          ...
                                          ecma_length_t arguments_number) /**< length of arguments' list */
{
  ...
  switch (builtin_routine_id)
  {
    ...
    default:
    {
      QKING_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_HOURS
  ...
  if (builtin_routine_id <= ECMA_DATE_PROTOTYPE_SET_UTC_DATE)
  {
    ...
    switch (builtin_routine_id)
    {
      ...
      default:
      {
        QKING_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_DATE
  ...
  else
  {
    ...
    switch (builtin_routine_id)
    {
      ...
      default:
      {
        QKING_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_UTC_MILLISECONDS
...
ecma_builtin_date_prototype_dispatch_routine (uint16_t builtin_routine_id, /**< built-in wide routine
                                              ...
                                              ecma_length_t arguments_number) /**< length of arguments' list */
{
  if (QKING_UNLIKELY (builtin_routine_id == ECMA_DATE_PROTOTYPE_TO_JSON))
  {
  ...
  switch (builtin_routine_id)
  {
    ...
    default:
    {
      QKING_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_TO_UTC_STRING);
