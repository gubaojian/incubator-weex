...
/* ES2015 22.2.3.4 */
OBJECT_VALUE(LIT_MAGIC_STRING_CONSTRUCTOR, ECMA_BUILTIN_ID_TYPEDARRAY,
...
ROUTINE(LIT_MAGIC_STRING_TO_STRING_UL,
        ecma_builtin_typedarray_prototype_object_to_string, 0, 0)
...
ROUTINE(LIT_MAGIC_STRING_FOR_EACH_UL,
        ecma_builtin_typedarray_prototype_for_each, 2, 1)
...
ROUTINE(LIT_MAGIC_STRING_REDUCE_RIGHT_UL,
        ecma_builtin_typedarray_prototype_reduce_right, 2, 1)
ROUTINE(LIT_MAGIC_STRING_FILTER, ecma_builtin_typedarray_prototype_filter, 2, 1)
ROUTINE(LIT_MAGIC_STRING_REVERSE, ecma_builtin_typedarray_prototype_reverse, 0,
        0)
ROUTINE(LIT_MAGIC_STRING_SET, ecma_builtin_typedarray_prototype_set, 2, 1)
ROUTINE(LIT_MAGIC_STRING_SUBARRAY, ecma_builtin_typedarray_prototype_subarray,
        2, 2)
