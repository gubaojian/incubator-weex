...
OBJECT_VALUE(LIT_MAGIC_STRING_CONSTRUCTOR, ECMA_BUILTIN_ID_REGEXP,
             ECMA_PROPERTY_CONFIGURABLE_WRITABLE)

/* ECMA-262 v5, 15.10.7.1 */
STRING_VALUE(LIT_MAGIC_STRING_SOURCE, LIT_MAGIC_STRING_EMPTY_NON_CAPTURE_GROUP,
             ECMA_PROPERTY_FIXED)
...
SIMPLE_VALUE(LIT_MAGIC_STRING_IGNORECASE_UL, ECMA_VALUE_FALSE,
             ECMA_PROPERTY_FIXED)
...
ROUTINE(LIT_MAGIC_STRING_TO_STRING_UL, ecma_builtin_regexp_prototype_to_string,
        0, 0)
