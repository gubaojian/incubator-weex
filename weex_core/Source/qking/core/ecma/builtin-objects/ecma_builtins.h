...
#define BUILTIN_ROUTINE(builtin_id, object_type, object_prototype_builtin_id, \
                        is_extensible, lowercase_name)                        \
  builtin_id,
#include "ecma_builtins.inc.h"
#undef BUILTIN
#undef BUILTIN_ROUTINE
#define BUILTIN_ROUTINE(a, b, c, d, e)
#define BUILTIN(builtin_id, object_type, object_prototype_builtin_id, \
                is_extensible, lowercase_name)                        \
  builtin_id,
#include "ecma_builtins.inc.h"
#undef BUILTIN
...
ecma_value_t ecma_builtin_dispatch_construct(
    ecma_object_t *obj_p, const ecma_value_t *arguments_list_p,
    ecma_length_t arguments_list_len);
ecma_property_t *ecma_builtin_try_to_instantiate_property(
    ecma_object_t *object_p, ecma_string_t *string_p);
...
bool ecma_builtin_is(ecma_object_t *obj_p, ecma_builtin_id_t builtin_id);
