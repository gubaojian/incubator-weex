...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_date.inc.h"
...
{
  QKING_UNUSED (this_arg);
  return ecma_make_number_value (floor (DOUBLE_TO_ECMA_NUMBER_T (qking_port_get_current_time ())));
