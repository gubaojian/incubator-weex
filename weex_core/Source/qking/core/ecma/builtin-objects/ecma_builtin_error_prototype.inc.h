...
OBJECT_VALUE(LIT_MAGIC_STRING_CONSTRUCTOR, ECMA_BUILTIN_ID_ERROR,
             ECMA_PROPERTY_CONFIGURABLE_WRITABLE)

/* ECMA-262 v5, 15.11.4.2 */
STRING_VALUE(LIT_MAGIC_STRING_NAME, LIT_MAGIC_STRING_ERROR_UL,
             ECMA_PROPERTY_CONFIGURABLE_WRITABLE)
...
ROUTINE(LIT_MAGIC_STRING_TO_STRING_UL,
        ecma_builtin_error_prototype_object_to_string, 0, 0)
