...
#define BUILTIN_INC_HEADER_NAME "ecma_builtin_object.inc.h"
...
{
  /* 1. */
  QKING_ASSERT (ecma_is_value_object (o_value));
  QKING_ASSERT (ecma_is_value_object (v_value) || ecma_is_value_null (v_value));
