...
OBJECT_VALUE(LIT_MAGIC_STRING_PROTOTYPE, ECMA_BUILTIN_ID_STRING_PROTOTYPE,
             ECMA_PROPERTY_FIXED)

/* Routine properties:
 *  (property name, C routine name, arguments number or NON_FIXED, value of the
 * routine's length property) */
ROUTINE(LIT_MAGIC_STRING_FROM_CHAR_CODE_UL,
        ecma_builtin_string_object_from_char_code, NON_FIXED, 1)
