...
ecma_init_global_lex_env (void)
{
  ...
  QKING_CONTEXT (ecma_global_lex_env_p) = ecma_create_object_lex_env (NULL,
                                                                      glob_obj_p,
...
{
  ecma_deref_object (QKING_CONTEXT (ecma_global_lex_env_p));
  QKING_CONTEXT (ecma_global_lex_env_p) = NULL;
...
{
  return QKING_CONTEXT (ecma_global_lex_env_p);
                     ...
                     ecma_string_t *name_p) /**< argument N */
{
  ...
  else
  {
    ...
    QKING_ASSERT (lex_env_type == ECMA_LEXICAL_ENVIRONMENT_THIS_OBJECT_BOUND
