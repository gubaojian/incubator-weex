...
#include "ecma_number_arithmetic.h"
...
{
  QKING_ASSERT (arguments_list_len == 0
                                 ...
                                 uint32_t flags) /**< configuration options */
{
  ...
  QKING_ASSERT (!ECMA_IS_VALUE_ERROR (completion)
                                          ...
                                          bool is_throw) /**< flag that controls failure handling */
{
  ...
  ecma_value_t completition = ecma_op_general_object_define_own_property (object_p,
                                                                          ...
                                                                          property_desc_p,
                                                                          false);
  QKING_ASSERT (ecma_is_value_boolean (completition));
...
ecma_op_array_list_lazy_property_names (ecma_object_t *obj_p, /**< a String object */
                                        ...
                                        ecma_collection_header_t *non_enum_collection_p) /**< skipped
                                                                                          ...
                                                                                          *   collection */
{
  QKING_ASSERT (ecma_get_object_type (obj_p) == ECMA_OBJECT_TYPE_ARRAY);
