...
ecma_object_t *ecma_new_standard_error_with_message(
    ecma_standard_error_t error_type, ecma_string_t *message_string_p);
#ifdef QKING_ENABLE_ERROR_MESSAGES
ecma_value_t ecma_raise_standard_error_with_format(
    ecma_standard_error_t error_type, const char *msg_p, ...);
#endif /* QKING_ENABLE_ERROR_MESSAGES */
