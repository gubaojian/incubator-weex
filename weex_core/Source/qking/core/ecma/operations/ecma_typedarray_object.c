                         ...
                         lit_magic_string_id_t class_id) /**< class name of the typedarray */
{
  ...
  /* 3 */
  QKING_ASSERT (ecma_op_is_callable (map_fn_val) || ecma_is_value_undefined (map_fn_val));
...
{
  QKING_ASSERT (ecma_is_typedarray (ecma_make_object_value (typedarray_p)));
...
ecma_op_typedarray_list_lazy_property_names (ecma_object_t *obj_p, /**< a TypedArray object */
                                             ecma_collection_header_t *main_collection_p) /**< 'main'
                                                                                           *   collection */
{
  QKING_ASSERT (ecma_is_typedarray (ecma_make_object_value (obj_p)));
                                   ...
                                   ecma_value_t value) /**< value of the property */
{
  ...
  QKING_ASSERT (ecma_is_value_empty (error));
  return true;
