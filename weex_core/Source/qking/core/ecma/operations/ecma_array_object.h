...
ecma_value_t ecma_op_array_object_set_length(ecma_object_t *object_p,
                                             ecma_value_t new_value,
                                             uint32_t flags);
...
void ecma_op_array_list_lazy_property_names(
