                                            ...
                                            bool is_throw) /**< flag that controls failure handling */
{
      ...
      || property_desc_p->is_writable_defined)
  {
    ...
    QKING_ASSERT (!property_desc_p->is_get_defined
  ...
  QKING_ASSERT (property_desc_p->is_configurable_defined || !property_desc_p->is_configurable);
  QKING_ASSERT (property_desc_p->is_enumerable_defined || !property_desc_p->is_enumerable);
  QKING_ASSERT (property_desc_p->is_writable_defined || !property_desc_p->is_writable);
  ...
  if (current_prop == ECMA_PROPERTY_TYPE_NOT_FOUND || current_prop == ECMA_PROPERTY_TYPE_NOT_FOUND_AND_STOP)
  {
    ...
    if (property_desc_type != ECMA_PROPERTY_TYPE_NAMEDACCESSOR)
    {
      ...
      QKING_ASSERT (property_desc_type == ECMA_PROPERTY_TYPE_GENERIC
                    || property_desc_type == ECMA_PROPERTY_TYPE_NAMEDDATA);
      ...
      QKING_ASSERT (property_desc_p->is_value_defined
  ...
  QKING_ASSERT (current_property_type == ECMA_PROPERTY_TYPE_NAMEDDATA
  ...
  if (current_property_type == ECMA_PROPERTY_TYPE_VIRTUAL)
  {
    QKING_ASSERT (!is_current_configurable && !ecma_is_property_writable (current_prop));
  ...
  else if (QKING_LIKELY (property_desc_type == current_property_type))
  {
    /* If property is configurable, there is no need for checks. */
    if (QKING_UNLIKELY (!is_current_configurable))
    {
  ...
  else
  {
    ...
    {
      QKING_ASSERT (current_property_type == ECMA_PROPERTY_TYPE_NAMEDACCESSOR);
      ecma_getter_setter_pointers_t *getter_setter_pair_p;
  ...
  if (property_desc_type == ECMA_PROPERTY_TYPE_NAMEDDATA)
  {
    QKING_ASSERT (ECMA_PROPERTY_GET_TYPE (*ext_property_ref.property_p) == ECMA_PROPERTY_TYPE_NAMEDDATA);
  ...
  {
    QKING_ASSERT (ECMA_PROPERTY_GET_TYPE (*ext_property_ref.property_p) == ECMA_PROPERTY_TYPE_NAMEDACCESSOR);
