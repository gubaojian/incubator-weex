 ...
 */
ecma_length_t QKING_ATTR_PURE
ecma_arraybuffer_get_length (ecma_object_t *object_p) /**< pointer to the ArrayBuffer object */
{
  QKING_ASSERT (ecma_object_class_is (object_p, LIT_MAGIC_STRING_ARRAY_BUFFER_UL));
 ...
 */
inline lit_utf8_byte_t * QKING_ATTR_PURE QKING_ATTR_ALWAYS_INLINE
