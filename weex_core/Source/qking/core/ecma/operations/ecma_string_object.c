                              ...
                              ecma_length_t arguments_list_len) /**< length of the arguments' list */
{
  ...
  if (arguments_list_len > 0)
  {
    ...
    QKING_ASSERT (ecma_is_value_string (prim_value));
  }
...
ecma_op_string_list_lazy_property_names (ecma_object_t *obj_p, /**< a String object */
                                         ...
                                         ecma_collection_header_t *non_enum_collection_p) /**< skipped
                                                                                           ...
                                                                                           *   collection */
{
  QKING_ASSERT (ecma_get_object_type (obj_p) == ECMA_OBJECT_TYPE_CLASS);
  ...
  QKING_ASSERT (ext_object_p->u.class_prop.class_id == LIT_MAGIC_STRING_STRING_UL);
