...
#define LIT_CHAR_BACKSLASH                           \
  ((ecma_char_t)'\\') /* reverse solidus (backslash) \
                       */
...
#define LIT_CHAR_ASCII_UPPERCASE_LETTERS_BEGIN \
  LIT_CHAR_UPPERCASE_A /* uppercase letters range */
#define LIT_CHAR_ASCII_UPPERCASE_LETTERS_END LIT_CHAR_UPPERCASE_Z

#define LIT_CHAR_ASCII_LOWERCASE_LETTERS_BEGIN \
  LIT_CHAR_LOWERCASE_A /* lowercase letters range */
...
bool lit_read_code_unit_from_hex(const lit_utf8_byte_t *buf_p,
...
/**
 * Minimum buffer size for lit_char_to_lower_case / lit_char_to_upper_case
 * functions.
 */
#define LIT_MAXIMUM_OTHER_CASE_LENGTH (3)

ecma_length_t lit_char_to_lower_case(ecma_char_t character,
                                     ecma_char_t *output_buffer_p,
                                     ecma_length_t buffer_size);
ecma_length_t lit_char_to_upper_case(ecma_char_t character,
                                     ecma_char_t *output_buffer_p,
                                     ecma_length_t buffer_size);
