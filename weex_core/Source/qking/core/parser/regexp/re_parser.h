...
typedef void (*re_char_class_callback)(void *re_ctx_p, ecma_char_t start,
                                       ecma_char_t end);

ecma_value_t re_parse_char_class(re_parser_ctx_t *parser_ctx_p,
                                 re_char_class_callback append_char_class,
                                 void *re_ctx_p, re_token_t *out_token_p);

ecma_value_t re_parse_next_token(re_parser_ctx_t *parser_ctx_p,
