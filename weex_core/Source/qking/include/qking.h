...
typedef uint32_t qking_magic_str_t;
...
/**
 * QKING_ASSERT fatal error code, can't be happen.
 */
typedef void (*qking_port_default_fatal_t)(int fatal_code);
...
qking_value_t qking_create_string_c(const char *str_p);
qking_value_t qking_create_string_lit(qking_magic_str_t name);
...
bool qking_value_is_null_or_undefined(const qking_value_t value);
...
bool qking_foreach_object_property_of(
    const qking_value_t obj_val, qking_object_property_foreach_t foreach_p,
    void *user_data_p,
    ...
    bool is_with_prototype_chain); /**< true - list properties from prototype
                                    * chain, false - list only own properties */
/**
...
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_STYLE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_CHILDREN;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_PROPS;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_STATE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_REF;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_KEY;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_DIV;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_WILL_MOUNT;
extern const qking_magic_str_t
    QKING_LIT_MAGIC_STRING_EX_COMPONENT_WILL_RECEIVE_PROPS;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_DID_MOUNT;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_WILL_UNMOUNT;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_WILL_UPDATE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_DID_UPDATE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_COMPONENT_DID_CATCH;
extern const qking_magic_str_t
    QKING_LIT_MAGIC_STRING_EX_SHOULD_COMPONENT_UPDATE;
extern const qking_magic_str_t
    QKING_LIT_MAGIC_STRING_EX_IS_PURE_COMPONENT_CLASS;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_IS_COMPONENT_CLASS;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_RENDER;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_SET_STATE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_UD_INTERNAL;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_PROTOTYPE;
