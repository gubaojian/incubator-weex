...
/**
 * Default implementation of qking_port_get_local_time_zone_adjustment. Uses the 'tm_gmtoff' field
 ...
 */
double qking_port_get_local_time_zone_adjustment (double unix_ms,  /**< ms since unix epoch */
                                                  bool is_utc)  /**< is the time above in UTC? */
{
  ...
  return 0.0;
#endif /* HAVE_TM_GMTOFF */
} /* qking_port_get_local_time_zone_adjustment */

/**
 * Default implementation of qking_port_get_current_time. Uses 'gettimeofday' if
