...
#ifndef QKING_ROOT_RAX_FUNC_ELEMENT_H
#define QKING_ROOT_RAX_FUNC_ELEMENT_H
...
class RaxFuncElement : public RaxElement {
 public:
  RaxFuncElement(uint32_t eid);
...
#endif  // QKING_ROOT_RAX_FUNC_ELEMENT_H
