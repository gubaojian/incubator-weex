...
#ifndef QKING_ROOT_RAX_EMPTY_ELEMENT_H
#define QKING_ROOT_RAX_EMPTY_ELEMENT_H
...
class RaxEmptyElement : public RaxElement {
 public:
  RaxEmptyElement(uint32_t eid);
...
#endif  // QKING_ROOT_RAX_EMPTY_ELEMENT_H
