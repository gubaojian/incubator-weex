...
#ifndef QKING_ROOT_RAX_ROOT_ELEMENT_H
#define QKING_ROOT_RAX_ROOT_ELEMENT_H
...
class RaxRootElement : public RaxElement {
 public:
  RaxRootElement(uint32_t eid);
  Json::object DebugCollectComponent() override;
  void DebugPrintComponent() override;
  inline RaxElement *&child() { return child_; };
 ...
 private:
  RaxElement *child_ = nullptr;
};
RAX_NAME_SPACE_END

#endif  // QKING_ROOT_RAX_ROOT_ELEMENT_H
