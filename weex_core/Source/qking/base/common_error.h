...
#include "core/parser/rax/qking_token.h"
#endif
...
class FatalError : public Error {
 public:
  FatalError(int code) : Error("[FatalError]=>", "code:" + to_string(code)) {}
};
...
class SyntaxError : public JSError {
 public:
  ...
  SyntaxError(std::string str = "") : JSError("SyntaxError ", std::move(str)) {}
